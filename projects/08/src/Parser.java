...
public class Parser implements Closeable {
  ...
  public String commandType() {
    ...
    } else if (commandParts[0].equals("goto")) {
      return CommandType.C_GOTO.name();
    } else if (commandParts[0].equals("label")) {
      return CommandType.C_LABEL.name();
    } else if (commandParts[0].equals("if-goto")) {
      return CommandType.C_IF.name();
    } else if (commandParts[0].equals("call")) {
      return CommandType.C_CALL.name();
    } else if (commandParts[0].equals("function")) {
      return CommandType.C_FUNCTION.name();
    } else if (commandParts[0].equals("return")) {
      return CommandType.C_RETURN.name();
    }
    return "";
  }
  ...
  public int arg2() {
    // System.out.println(commandParts[2].split("\\s+")[0]);
    return Integer.parseInt(commandParts[2].trim());
  }
}
