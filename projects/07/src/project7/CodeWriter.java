...
public class CodeWriter {
  ...
  public void writePushPop(String command, String segment, int index, String fileName) {
    if (command.equals("C_PUSH")) {
      ...
      if (segment.equals("constant")) {
        ...
        staticAndPointerPushPop(segment, index, fileName, "push");
      }
      ...
      if (Arrays.asList(mem_segments).contains(segment)) {
        ...
        staticAndPointerPushPop(segment, index, fileName, "pop");
      }
    }
  }
  ...
  private void staticAndPointerPushPop(String segment, int index, String fileName, String operation) {
    String seg = "";
